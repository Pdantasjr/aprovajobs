    ...
    <AppLayout>
        <MainContent>
            ...
            <transition>
                ...
                <p>{{ this.form.category }}</p>
                <p>{{ this.form.deadline }}</p>
            <form @submit.prevent="submit">
                <AppLabel text="Título da da demanda:" for-input="title" required />
                <AppInput name="title" id="title" v-model="form.title" autofocus required/>

                <AppLabel text="Descreva sua demanda:" for-input="description" required />
